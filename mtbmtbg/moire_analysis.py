...
import mtbmtbg.moire_shuffle as mshuff
...
def analyze_moire_potential(n_moire: int, n_g: int, datatype=DataType.CORRU, valley=ValleyType.VALLEYK1) -> dict:
    ...
    for kpnt in high_symm_pnts:
        ...
        moire_hamk[kpnt] = mshuff.tbplw_shuffle_to_cont(hamk)

    print("="*100)

    return {'glist': o_g_vec_list, 'mpot': moire_potential, 'mhamk':moire_hamk}
